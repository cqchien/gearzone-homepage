...
function AccountPage() {
  ...
  const [activeKey, setActiveKey] = useState(() =>
    pathname.replace(`${ROUTES.ACCOUNT}/`, ''),
  );
  // menu list
  const menu = [
    {
  ...
  useEffect(() => {
    if (pathname === `${ROUTES.ACCOUNT}/orders`)
      setActiveKey('orders');
  }, [pathname]);
        ...
        <Row className="account-page container m-tb-32">
          <Col className="p-r-16" span={24} md={6}>
            ...
            <div className="d-flex p-b-4 m-b-12 intro">
              <img src={userLogo} width={32} height={32} className="m-r-12" alt='user' />
              <div>
